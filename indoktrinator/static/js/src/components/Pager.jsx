...
export var Pager = React.createClass({
  ...
  render() {
    ...
    var previous = <li className={prevActive}><a onClick={this.props.previous}><i
      className="glyphicon glyphicon-arrow-left"></i> {this.props.previousText}</a></li>

    var nextActive = this.props.currentPage != (this.props.maxPage - 1) ? '' : 'disabled'
    var next = <li className={nextActive}><a onClick={this.props.next}>{this.props.nextText} <i
      className="glyphicon glyphicon-arrow-right"></i></a></li>
